...
public class PublicController {
    ...
    public ResponseEntity<String> login(@RequestBody UserLoginDTO userLoginDTODetails) {
        try {
            ...
            UserDetails userDetails = userDetailsService.loadUserByUsername(userLoginDTODetails.getUsername());
            return new ResponseEntity<>("Welcome to Notes", HttpStatus.CREATED);
        } catch (Exception e) {
